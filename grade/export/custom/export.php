...
$userlist          = optional_param('userlist', null, PARAM_INT);
...
$export = new grade_export_custom($courses, $groupid, $itemids, $export_feedback, $updatedgradesonly, $displaytype, $decimalpoints, $onlyactive, true, $userlist);
$export->print_grades();